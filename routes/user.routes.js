...
import { addPlant, deleteDevice, deviceControl, passwordUpdate, profile, profileUpdate, registerDevice } from '../controllers/user.controller.js';
...
userRouter.post('/delete-device', trimRequest.all, deleteDevice);
